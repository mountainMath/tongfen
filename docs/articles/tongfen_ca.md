...
![](tongfen_ca_files/figure-html/unnamed-chunk-3-1.png)

## Aggregating up data across regions

Another application is simply aggregating up variables for a selection
of regions from a single census. Suppose we want to understand the share
of renters in the Vancouver School District, as well as the share of
renter households spending more than 30% of income on housing.
...
53% of Vancouver School District households rent, 45% of which are
shelter cost burdened.

### Change in Vancouver children

Data can also be obtained at dissemination area level. As an example we
look at the change in children aged 0 to 14 in the Vancouver School
District.
...
![](tongfen_ca_files/figure-html/unnamed-chunk-5-1.png)
