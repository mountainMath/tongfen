...
```{r}
#remotes::install_github("mountainmath/cancensusHelpers")
...
`r scales::percent(old_toronto$rent_share)` of Old Toronto households rent, `r scales::percent(old_toronto$rent_poor)` of which are shelter cost burdened.
